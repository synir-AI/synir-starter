    ...
    <main className="min-h-screen bg-[#F5F5F4] text-[#2F3E46]">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
        <header className="mb-6">
          <h1 className="text-3xl font-semibold">Generate AI Image</h1>
          <p className="mt-2 text-[#2F3E46]/80">Create high-quality images from text prompts.</p>
        </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-4">
              <label className="block">
                ...
                <textarea
                  className="mt-2 w-full rounded-xl border border-[#CFCFCF] bg-white p-3 outline-none focus:ring-2 focus:ring-[#4ECDC4]"
                  rows={5}
              ...
              <label className="block">
                ...
                <input
                  className="mt-2 w-full rounded-xl border border-[#CFCFCF] bg-white p-3 outline-none focus:ring-2 focus:ring-[#4ECDC4]"
                  placeholder="fixed number for reproducibility"
                  value={seed}
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="rounded-xl bg-[#4ECDC4] px-4 py-2 font-semibold text-[#2F3E46] disabled:opacity-50"
                >
            ...
            <div>
              <div className="aspect-video rounded-xl bg-[#EDEDED] flex items-center justify-center overflow-hidden">
                {result ? (
                  ...
                  <span className="text-[#2F3E46]/60 text-sm">Result preview will appear here</span>
                )}
              </div>
              {result && (
                <a href={result} download="generated.png" className="mt-4 inline-block rounded-xl border border-[#2F3E46] px-4 py-2 font-semibold hover:bg-[#EDEDED]">Download</a>
              )}
            </div>
          </div>
        </section>
