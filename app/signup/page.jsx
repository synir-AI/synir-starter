    ...
    <main className="min-h-screen bg-[#F5F5F4] text-[#2F3E46]">
      <div className="mx-auto max-w-md px-4 sm:px-6 lg:px-8 py-12">
        <header className="mb-6">
          ...
          <p className="mt-2 text-[#2F3E46]/80">Start creating in seconds. (Placeholder)</p>
        </header>
        <form className="rounded-2xl bg-white border border-[#E6E6E6] p-6 shadow-sm space-y-4">
          ...
          <button type="button" className="w-full rounded-xl bg-[#4ECDC4] px-4 py-2 font-semibold text-[#2F3E46] hover:opacity-90">Create account</button>
          <p className="text-sm text-[#2F3E46]/80">Already have an account? <a className="underline" href="/login">Log in</a>.</p>
        </form>
        <div className="mt-6">
